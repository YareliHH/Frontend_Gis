        ...
        <Container maxWidth="lg">
          <Grid container spacing={5} justifyContent="space-between">
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                {[
                  { label: 'Preguntas Frecuentes', path: '/preguntasF', icon: <QuestionAnswer sx={{ fontSize: 22, mr: 1.2 }} /> },
                  { label: 'Contáctanos', path: '/contacto', icon: <ContactSupport sx={{ fontSize: 22, mr: 1.2 }} /> },
                  { label: 'Política de Privacidad', path: '/avisosprivacidad', icon: <Security sx={{ fontSize: 22, mr: 1.2 }} /> },
                  { label: 'Términos y Condiciones', path: '/terminoscondiciones', icon: <Gavel sx={{ fontSize: 22, mr: 1.2 }} /> },
                  { label: 'Deslinde Legal', path: '/deslindelegal', icon: <AssignmentLate sx={{ fontSize: 22, mr: 1.2 }} /> },
                ].map((link) => (
                  <Link
                    key={link.label}
                    component="button"
