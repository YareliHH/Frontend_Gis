  ...
  useEffect(() => {
     axios.get('http://localhost:3001/api/termiCondicion/terminos_condiciones')
      ...
      .catch(error => {
        ...
        setContenido('Error al cargar los términos y condiciones.');
      })
      ...
      <Fade in timeout={500}>
        <Box mt={6} mb={10}>
              ...
              {loading ? (
                ...
                >
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mt: 1, opacity: 0.7 }}>
                    Preparando información legal para el uso del sitio
                  </Typography>
                </Box>
              ) : (
          ...
          <Box mt={8} textAlign="center">
            ...
            >
              ...
              <Box textAlign="left">
                ...
                <Typography variant="caption" color="text.secondary" sx={{ opacity: 0.8 }}>
                  Consulta periódicamente los términos para conocer cambios
                </Typography>
              </Box>
            </Paper>
            ...
            >
              Al utilizar este sitio, aceptas nuestros términos y condiciones. 
