  ...
  useEffect(() => {
    axios.get('http://localhost:3001/api/politicas/politicas_privacidad')
      ...
      .catch(error => {
        ...
        setContenido('Error al cargar la política de privacidad.');
      })
      ...
      <Fade in timeout={500}>
        <Box mt={6} mb={10}>
              ...
              {loading ? (
                ...
                >
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mt: 1, opacity: 0.7 }}>
                    Preparando la información de seguridad
                  </Typography>
                </Box>
              ) : (
          ...
          <Box mt={8} textAlign="center">
            ...
            >
              ...
              <Box textAlign="left">
                ...
                <Typography variant="caption" color="text.secondary" sx={{ opacity: 0.8 }}>
                  Revisamos constantemente nuestras políticas
                </Typography>
              </Box>
            </Paper>
            ...
            >
              Si tienes preguntas sobre esta política, no dudes en contactarnos. 
