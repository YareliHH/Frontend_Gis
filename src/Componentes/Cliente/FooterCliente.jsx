  ...
  return (
    <Box sx={{ position: 'relative' }}>
      ...
      <Box
        component="footer"
        sx={{
          background: 'linear-gradient(135deg, #0097a7 0%, #87CEEB 100%)',
          color: '#fff',
          ...
          '&::before': {
            ...
            right: 0,
            height: '4px',
            background: 'linear-gradient(90deg, #00796b, #0097a7, #87CEEB)',
          },
        }}
      >
      ...
      >
        <DialogTitle
          sx={{
            background: 'linear-gradient(90deg, #0097a7, #87CEEB)',
            color: 'white',
            py: 2,
            px: 3,
            display: 'flex',
