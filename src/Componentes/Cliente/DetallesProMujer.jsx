    ...
    <Box padding={3} sx={{ backgroundColor: '#f9f9f9' }}>
      <Grid container spacing={4} alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body2" sx={{ color: 'black', marginBottom: '20px' }}>
            ideal para climas cálidos. Confortable y resistente para uso prolongado.
            <br />
            
            Resistente al lavado frecuente, transpirable, y con acabado suave al tacto.
          </Typography>
...
export default DetallesProMujer;
