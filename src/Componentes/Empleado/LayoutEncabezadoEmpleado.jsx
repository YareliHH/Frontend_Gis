...
import EncabezadoAdministrativo from '../Empleado/EncabezadoEmpleado';
import PieDePagina from '../Empleado/FooterEmpleado';
 ...
 */
const LayoutConEncabezadoEmple = ({ children }) => {
  return (
...
export default LayoutConEncabezadoEmple;